...
export const myProjects: Post[] = [
  ...
  },
  {
    ...
    title: 'Show tracker',
    date: '2024',
    summary: 'Personal TV show diary with Firebase auth/sync, TMDB search, and custom lists—built to run on the free Spark tier.',
    imageUrl: '/project-show.png',
    context: 'Track what you watch with TMDB-powered search and manage lists (add/delete and sort by recently added).',
    action: 'Static hosting with Firebase Authentication + Firestore. TMDB integration runs client-side on Spark (TMDB key exposure clarified) with an optional Blaze Cloud Functions proxy. Includes a TMDB API key rotation script so you can update credentials without committing secrets.',
    impact: 'Low-cost show logging with genuinely useful list management and simpler credential maintenance as your TMDB key changes.',
    tech: ['HTML', 'JavaScript', 'Firebase', 'Firestore', 'TMDB API', 'Cloud Functions'],
    links: [
