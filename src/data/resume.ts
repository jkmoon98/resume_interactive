...
/** Profile + grid photos live in `public/` — swap files anytime, keep these paths or update below */
const profilePhoto = '/profile.png'
const P = {
  profile: '/profile.png',
  beach: '/photo-beach.png',
  dog: '/photo-dog.png',
  bench: '/photo-bench.png',
} as const
...
export const profile: Profile = {
  ...
  links: [
    ...
    { label: 'GitHub', url: 'https://github.com/jkmoon98' },
